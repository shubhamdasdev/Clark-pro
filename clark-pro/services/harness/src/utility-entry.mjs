...
process.parentPort.once("message", (connectionEvent) => {
  ...
  engine.on("skill.updated", (payload) => emitProtocolEvent("skill.updated", payload));
  engine.on("tool_package.updated", (payload) => emitProtocolEvent("tool_package.updated", payload));
