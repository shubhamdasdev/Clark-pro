...
- One Playwright Electron flow per journey, retaining PMAgent naming `TF-006-journey-a|b|c`; do not split state continuity.
...
|------|---------|--------|--------|
| 2026-07-13 | 1.0 | PM Agent | Created — 3 journeys cover all AC across 8 stories and bind HP-002, HP-003, HP-004, HP-006, HP-008. |
