...
| PMAgent bucket | Clark executor | Use | Evidence |
|----------------|----------------|-----|----------|
...
|------|---------|--------|--------|
| 2026-07-13 | 1.0 | PM Agent | Created full QA strategy aligned to 42 story plans, 3 release plans, 3 evergreen flow plans, 10 probes, analytics, and architecture gates. |
